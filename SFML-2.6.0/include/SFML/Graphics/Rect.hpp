...
public:
    ...
    template<typename U>
    friend std::ostream& operator<<(std::ostream& os, const sf::Rect<U>& rect);

    template<typename U>
    friend std::istream& operator>>(std::istream& in, sf::Rect<U>& rect);
...
template<typename U>
std::ostream& operator<<(std::ostream& os, const sf::Rect<U>& rect)
{
    os << rect.getPosition() << " " << rect.getSize();
    return os;
}

template<typename U>
std::istream& operator>>(std::istream& in, sf::Rect<U>& rect)
{
    in >> rect.left >> rect.top >> rect.width >> rect.height;
    return in;
}
////////////////////////////////////////////////////////////
/// \relates Rect
